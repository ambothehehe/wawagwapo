...
class ExtraCurricular extends CI_Controller
{
	...
	public function reports() {
		...
		{	
			...
			$this->load->view('extra-curricular/extra_curricular_report', $data);
		}else{
			redirect(site_url());
		}
	}
	...
	public function create_report() {
		...
		$this->load->view('extra-curricular/extra_curricular_create_report', $data);
	}
...
//for form d create report form D
	public function form_d() {
		...
		$this->load->view('forms/form_d_extra', $data);
		}else{
			?><script type="text/javascript">alert("NO AVAILABLE PROPOSALS TO BE REPORTED");</script><?php
			redirect(site_url('ExtraCurricular/create_report'), "refresh");
		}
	}
	...
	public function addFormd() {
			...
			if(!$result){
				...
				redirect(site_url('ExtraCurricular/reports'), "refresh");
			}
			else{
