...
public function addFormd() {
			...
			$data['email']=$this->Proposal_AB->getFacultyEmail($this->session->organization,9); //get Faculty Email

			$data2['email']=$this->Proposal_AB->getChairEmail($this->session->department, 4); //get Chair Email
			...
			$this->email->message('Good day! You have a report to be noted.');
