...
<head>
    <title>CESPPMS - Your Profile Settings</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
              <?php include('application/views/messages.php'); ?>
                ...
                <form  id="save_edit_profile_settings" >
                    <!-- Account Settings -->
                          ...
                          <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-9"></div>
                                <div class="col-md-3">
                                  <button type="submit" class="btn btn-primary" name="save" value="save" id="save_profile_settings" style="width:100%"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>&nbsp SAVE</button>
                                </div>
                            </div>
                          </div>
                        </div>
