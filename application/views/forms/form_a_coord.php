...
<!-- END of proposal header -->
                       ...
                       <!--  <input type="hidden" name="procedure_num" value="3"> -->
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                              <button type="button" id = "save_a_coord" class="btn btn-default btn-block" data-toggle="modal" value="save_prop" data-target="#saveasdraft"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>&nbsp SAVE & QUIT</button>
                            </div>
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center">
                              <button type="submit" class="btn btn-success btn-block" id="submit" name="submit" value="submit_prop_coord" onsubmit= "window.location='<?php echo base_url(); ?>index.php/Representative/send'"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>&nbsp Submit</button>
                            </div>
