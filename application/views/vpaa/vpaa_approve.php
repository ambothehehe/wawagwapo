        ...
        <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header text-center">
                        <h1><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>&nbsp; Proposals For Approval</h1>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                ...
                <div class="row tab-content">
                    ...
                    <table id="vpaaForApprove" class="table table-striped table-bordered table-hover lists-table">
                        <thead>
...
<script type="text/javascript">
        $(document).ready(function(){
			...
			var vpaaForApproval = $('#vpaaForApprove').dataTable({
                "pagingType": "full_numbers",  
            });
                
            $.ajax({
                type: "POST",
                url: base_url + "Vpaa/getToBeEndorsedProposal",
                success:function(data2){
					...
					if(dataRows.length > 0){
						vpaaForApproval.fnAddData(dataRows);
					}else{
