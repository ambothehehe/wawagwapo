                ...
                <div class="row tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-header text-center">
                                <h1><span class="glyphicon glyphicon-file" aria-hidden="true"></span>&nbsp My Reports <i>(Form D)</i></h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody> 
                        ...
                        <?php foreach($repaps as $reps) {?>
                                    ...
                                    <tr>
                                        <td><a href="<?php echo base_url() ?>/Faculty/loadreportd/<?php echo $reps->id; ?>"><?php echo $reps->fd_title;?></a></td>
